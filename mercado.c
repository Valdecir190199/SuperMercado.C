...
void Vender()
{
    ...
    arquivoVenda = abrir_arquivo("venda.dat");
    ...
    arquivoProduto = abrir_arquivo("produto.dat");
    fseek(arquivoProduto, 0, SEEK_SET);

    arquivoCliente = abrir_arquivo("cliente.dat");
...
void listar_produto()
{
    ...
    while (fread(&produto, sizeof(Produto), 1, arquivo))
    {
        ...
        cout << produto.codigo << " - " << produto.nome << endl;
    }
...
int main()
{
    ...
    do
    {
        ...
        cout << "Bem Vindo Ao Super Mercado" << endl;
        cout << "---------------------------" << endl;
        cout << "1 Cliente" << endl;
        cout << "2 Produto" << endl;
        cout << "3 Venda" << endl;
